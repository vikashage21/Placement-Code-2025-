      ...
      <div className="overflow-x-auto rounded-xl shadow-xl">
        <table className="min-w-full bg-[#111827] border border-gray-700 rounded-xl">
          <thead className="bg-gray-800">
            <tr>
              <th className="px-6 py-4 border-b border-gray-700 text-left">#</th>
              <th className="px-6 py-4 border-b border-gray-700 text-left">Name</th>
              <th className="px-6 py-4 border-b border-gray-700 text-left">Email</th>
              <th className="px-6 py-4 border-b border-gray-700 text-left">Message</th>
              <th className="px-6 py-4 border-b border-gray-700 text-left">Date</th>
            </tr>
          </thead>
