    ...
    <nav className="bg-white shadow-md fixed top-0 left-0 w-full z-50  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-8 text-gray-700 font-medium">
          ...
          <li className="cursor-target"><Link to="/contact">Contact</Link></li>
        </ul>
      ...
      {open && (
        <ul className="md:hidden bg-white px-6 pb-4 space-y-4 text-gray-700 font-medium shadow">
          ...
          <li><Link to="/company" onClick={() => setOpen(false)}>Company</Link></li>
          <li><Link to="/services" onClick={() => setOpen(false)}>Services</Link></li>
          <li><Link to="/news" onClick={() => setOpen(false)}>News & Blogs</Link></li>
